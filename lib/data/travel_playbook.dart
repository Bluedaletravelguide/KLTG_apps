...
//     final attractions = {
//       'general': [
//         {'name': 'Petronas Twin Towers', 'desc': 'Iconic 452m towers with skybridge', 'time': '2-3 hrs'},
//         {'name': 'Batu Caves', 'desc': '272 rainbow stairs, Hindu temple', 'time': '2 hrs'},
//         {'name': 'KL Tower', 'desc': '421m observation deck views', 'time': '1-2 hrs'},
//         {'name': 'Merdeka Square', 'desc': 'Historic independence site', 'time': '1 hr'},
//         {'name': 'KLCC Park', 'desc': 'Free fountain show at 8pm', 'time': '1 hr'},
//         {'name': 'Central Market', 'desc': 'Art & handicraft shopping', 'time': '1-2 hrs'},
//         {'name': 'Islamic Arts Museum', 'desc': 'Stunning architecture & exhibits', 'time': '2 hrs'},
//         {'name': 'Thean Hou Temple', 'desc': '6-tier Chinese temple', 'time': '1 hr'},
//         {'name': 'Bukit Bintang', 'desc': 'Shopping & nightlife district', 'time': '3-4 hrs'},
//         {'name': 'Perdana Botanical Garden', 'desc': '92-hectare green oasis', 'time': '2-3 hrs'},
//       ],
//       'penang': [
//         {'name': 'Street Art Murals', 'desc': 'Famous Georgetown art', 'time': '2-3 hrs'},
//         {'name': 'Kek Lok Si Temple', 'desc': 'Largest Buddhist temple', 'time': '2 hrs'},
//         {'name': 'Penang Hill', 'desc': 'Cable car & panoramic views', 'time': '3 hrs'},
//         {'name': 'Clan Jetties', 'desc': 'Historic waterfront villages', 'time': '1 hr'},
//         {'name': 'Fort Cornwallis', 'desc': '1786 British fort', 'time': '1 hr'},
//       ],
//     };
...
//         {'name': 'Feeka Coffee', 'dish': 'Waffles & coffee', 'price': 'RM25-40'},
//         {'name': 'Delicious', 'dish': 'Western brunch', 'price': 'RM30-45'},
//       ],
//       'klcc_evening': [
//         {'name': 'Jalan Alor', 'dish': 'Street food paradise', 'price': 'RM15-30'},
//         {'name': 'Madam Kwan\'s', 'dish': 'Nasi lemak', 'price': 'RM20-35'},
//         {'name': 'Lot 10 Hutong', 'dish': 'Food court classics', 'price': 'RM15-25'},
//       ],
//       'bukit_bintang_evening': [
//         {'name': 'Jalan Alor', 'dish': 'Grilled seafood, satay', 'price': 'RM20-40'},
//         {'name': 'Lot 10 Hutong', 'dish': 'KL best hawker food', 'price': 'RM15-30'},
//         {'name': 'Imbi Market', 'dish': 'Curry laksa', 'price': 'RM10-15'},
//       ],
//       'general_budget': [
//         {'name': 'Mamak Stalls', 'dish': 'Roti canai, nasi lemak', 'price': 'RM5-15'},
//         {'name': 'Food Courts', 'dish': 'Mixed local dishes', 'price': 'RM8-20'},
//         {'name': 'Chow Kit Market', 'dish': 'Local breakfast', 'price': 'RM5-12'},
//       ],
//       'general': [
//         {'name': 'Nasi Lemak', 'dish': 'Coconut rice breakfast', 'price': 'RM8-25'},
//         {'name': 'Char Kuey Teow', 'dish': 'Wok-fried noodles', 'price': 'RM8-15'},
...
//     String key = isBudget ? 'general_budget' : 
//                  location != 'general' ? '${location}_$time' : 'general';
...
//     if (location != 'general') result += " near ${location.replaceAll('_', ' ')}";
//     result += "! 😋\n\n";
...
//     final malls = [
//       {'name': 'Pavilion KL', 'type': 'Luxury brands', 'area': 'Bukit Bintang', 'budget': 'High'},
//       {'name': 'Suria KLCC', 'type': 'Premium shopping', 'area': 'KLCC', 'budget': 'High'},
//       {'name': 'TRX Exchange', 'type': 'Newest & fanciest', 'area': 'TRX', 'budget': 'High'},
//       {'name': 'Mid Valley', 'type': 'Massive selection', 'area': 'Mid Valley', 'budget': 'Mid'},
//       {'name': 'Sunway Pyramid', 'type': 'Family entertainment', 'area': 'Sunway', 'budget': 'Mid'},
//       {'name': 'Central Market', 'type': 'Souvenirs & crafts', 'area': 'Chinatown', 'budget': 'Low'},
//       {'name': 'Petaling Street', 'type': 'Bargain shopping', 'area': 'Chinatown', 'budget': 'Low'},
//       {'name': '1 Utama', 'type': 'Huge mall with rainforest', 'area': 'PJ', 'budget': 'Mid'},
//     ];
    
//     final filtered = budget != null && budget < 100 
//         ? malls.where((m) => m['budget'] == 'Low' || m['budget'] == 'Mid').toList()
//         : malls;
...
//     final from = query.toLowerCase().contains('airport') ? 'airport' :
//                  query.toLowerCase().contains('klcc') ? 'klcc' : 'general';
...
//   // ========== ATTRACTIONS (DYNAMIC) ==========
//   QA(
//     patterns: ['attraction', 'see', 'visit', 'sights', 'landmarks', 'tourist', 'top places', 'must see'],
//     answerType: 'dynamic',
...
//   // ========== FOOD (DYNAMIC) ==========
//   QA(
//     patterns: ['food', 'eat', 'hungry', 'restaurant', 'dishes', 'breakfast', 'lunch', 'dinner'],
//     answerType: 'dynamic',
...
//   // ========== TRANSPORT (DYNAMIC) ==========
//   QA(
//     patterns: ['transport', 'travel', 'getting around', 'how to get', 'move around', 'grab', 'taxi'],
//     answerType: 'dynamic',
...
//   // ========== BUDGET (DYNAMIC) ==========
//   QA(
//     patterns: ['budget', 'cost', 'expensive', 'cheap', 'money', 'price', 'how much'],
//     answerType: 'dynamic',
...
//   // ========== WEATHER ==========
//   QA(
//     patterns: ['weather', 'rain', 'hot', 'humid', 'temperature', 'when to visit', 'best time'],
...
//   // ========== CAMERON HIGHLANDS ==========
//   QA(
//     patterns: ['cameron highlands', 'tea', 'strawberry', 'highland', 'cool weather'],
...
//   // ========== MEDICAL ==========
//   QA(
//     patterns: ['medical', 'hospital', 'health', 'doctor', 'treatment', 'check up'],
